...
#		bot.forward_message(TO_CHAT_ID, f"От: <a href='tg://user?id={msg.from_user.id}'>{msg.from_user.first_name}</a", parse_mode="HTML")
		
		bot.forward_message(TO_CHAT_ID, msg.chat.id, msg.from_user.id)
