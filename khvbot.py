...
def all_messages(msg):
	...
	if msg.chat.id == TO_CHAT_ID:
		...
		if msg.text.lower() == "/l":
			...
			bot.send_photo(-1001446448774, msg.reply_to_message.photo[0].file_id, caption = f"👤 от <b>{msg.forward_from.first_name}</b>: {msg.reply_to_message.caption}\n\n<a href='tg://user?id={msg.forward_from.id}'>📝 Написать</a>", parse_mode="HTML")
		else:
