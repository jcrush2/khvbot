...
def all_messages(msg):
	...
	if msg.chat.id == TO_CHAT_ID:
		...
		if msg.text.lower() == "/l":
			...
			bot.send_photo(-1001446448774, msg.reply_to_message.photo[0].file_id, caption = f"👤 от <b>{msg.reply_to_message.from_user.first_name}</b>: {msg.reply_to_message.caption}\n\n<a href='tg://user?id={msg.reply_to_message.from_user.id}'>📝 Написать</a>", parse_mode="HTML")
		else:
